  ...
  return (
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
      ...
      <div className="w-full flex flex-col lg:flex-row gap-16">
                ...
                cartItems.map((item) => (
                  ...
                  >
                    <div className="flex gap-8">
                      {/* IMAGE */}
                      <div className="relative bg-gray-50 rounded-lg w-32 h-32 overflow-hidden">
                        <Image
                      ...
                      <div className="flex flex-col justify-between h-max">
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-xs text-gray-500">
                            Color:{" "}
                            {item.selectedColor.replace(/\b\w/g, (char) =>
                              char.toUpperCase(),
                            )}
                          </p>
                        </div>
        ...
        {/* DETAILS */}
        <div className="w-full lg:w-5/12 shadow-lg border-gray-100 p-8 rounded-lg flex flex-col gap-4">
          ...
          {activeStep === 1 && (
            <button
              ...
              className="w-full bg-gray-800 hover:bg-gray-900 transition-all duration-300 p-2 text-white rounded-lg cursor-pointer flex items-center justify-center gap-2"
            >
              Continue
